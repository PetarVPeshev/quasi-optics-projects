...
title('Broadside Directivity @ quartz lens, f = 70 GHz');
saveas(gcf, 'figures\dir_lens_quartz.fig');

%% SAVE WORKSPACE
lens_quartz.dir_broadside = dir_broadside;
lens_quartz.D_ratio = D_ratio;
lens_quartz.theta_max = theta_max;
save('results\dir_lens_quartz.mat', 'lens_quartz');
